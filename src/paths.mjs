...
export const NATIVE_ROUTE_LEASE_PATH = path.join(STATE_DIR, "native-route-lease.json");
export const NATIVE_ROUTE_LEASE_LOCK_PATH = path.join(STATE_DIR, "native-route-lease.lock");
